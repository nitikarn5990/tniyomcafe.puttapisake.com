...
<script type="text/javascript">
    function printDiv2(divId) {
        ...
        document.body.innerHTML = "<html><head><link rel='stylesheet' href='<?= base_url() ?>assets/bootstrap/css/bootstrap.min.css' media='print'><link rel='stylesheet' href='<?= base_url() ?>assets/dist/css/AdminLTE.css' media='print'><link rel='stylesheet' href='<?= base_url() ?>assets/dist/css/skins/_all-skins.min.css' media='print'><link rel='stylesheet' href='<?= base_url() ?>assets/ionicons/css/ionicons.min.css'></head><body>" + printContents + "</body></html>";
        window.print();
...
<!--                                        To <input type="text" readonly="" data-validation="required" placeholder="คลิกเลือกเดือนสุดท้าย" class="form-control" id="daterange_month_end" name="daterange_month_end" value="" style="min-width: 150px;">   -->
                                    ...
                                    <p>
                                        ...
                                        <button type="button" class="btn btn-flat bg-blue col-md-1 col-xs-12 pull-right"  onclick="printDiv('box-content')"><i class="fa fa-print"></i> Print</button>                                                                               
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="view_gp">
                                            <div class="table-responsive">
                                                ...
                                                <p>&nbsp;</p>
                                                <div class="col-md-10 col-xs-12" style="" id="gp2">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="active tab-pane" id="view_gp">
                                            <div class="table-responsive">
                                                ...
                                                <p>&nbsp;</p>
                                                <div class="" style="width: 80%;" id="gp2">
                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="active tab-pane" id="view_gp_product">
                                            <div class="table-responsive">
                                                <div class="" style="width: 80%;" id="gp_product">
...
//                            $('#reservation222').daterangepicker({
//                                format: 'DD/MM/YYYY',
//                            },
