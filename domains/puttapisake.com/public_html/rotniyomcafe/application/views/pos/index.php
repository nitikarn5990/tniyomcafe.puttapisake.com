...
<section class="content">
    ...
    <div class="row">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        ...
                                        <button type="button" class="btn btn-flat btn-danger pull-right clear-table"
                                                onclick="clear_table()">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        ...
                                        <button type="button" class=" btn btn-flat btn-danger pull-right clear-order"
        ...
        <?php if ($pos == 'barista') { ?>
            ...
            <div class="col-md-5 col-md-pull-7" id="main-control">
                                                ...
                                                <table class="table table-advance" id="">
                                                    <thead>
                                                        <tr class="bg-gray">
                                                            ...
                                                            <th class="hidden" style="font-weight: bold"> Order Date</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        audioElement.setAttribute('src', '<?= base_url('sound.mp3') ?>');
...
<script>
    ...
    function row_select(ele) {
        ...
        $('#active_order_id_selected_detail').val($(ele).attr('data-active-order-id'));
            ...
            //ปิดการ เครีย order ถ้ามีการทำแล้ว และกำลังทำ
      //console.log($(ele));
        if( $(ele).hasClass('bg-green') || $(ele).hasClass('bg-yellow')){
            //console.log('has');
            $('.clear-order').attr('disabled',true);
        }else{
              $('.clear-order').attr('disabled',false);
        }
...
<?php if ($pos == 'tables') { ?>
        setInterval("SumMainTable()", 2000);
        setInterval("SumDetailTable()", 2000);
<?php } ?>
<?php if ($pos == 'buy_back_home') { ?>

        //back home
        setInterval('SumMainTableBackHome()', 2000);
        setInterval('SumDetailTableBackHome()', 2000);
...
<?php if ($pos == 'barista') { ?>
        ...
        //back home
        setInterval("SumMainTableBarista()", 2000);
        setInterval("SumDetailTableBarista()", 2000);
<?php } ?>
    var count_row_barista = 0;
    var count_total_qty_barista_old = 0; //นับจำนวนสินค้าก่อนหน้า
    var count_total_qty_barista = 0;
...
//                                                                }
    ...
    function SumMainTableBarista() {
        ...
        var count_row_barista_current = 0; //นับ row ปัจจุบัน
            ...
            success: function (data2) {
                ...
                $.each(data, function (i, val) {
                    ...
                    if (status === '0') {
                        ...
                        tr_0 += "<td id='item_count'>" + barista_total_qty + "</td>";
                        tr_0 += "<td class='hidden'>฿  " + total_price + ".00</td>";
                        // tr_0 += "<td>  " + created_at + "</td>";
                        tr_0 += "</tr>";

                        count_row_barista_current = count_row_barista_current + 1;
                        // count_total_qty_barista_current = count_total_qty_barista_current + barista_total_qty;

                        count_total_qty_barista_current = count_total_qty_barista_current + parseInt(val.total_qty);
...
//                        tr_1 += "</tr>";
    ...
    function clear_backhome_no_popup() {
            ...
            if (item_id !== '') {
                $.ajax({
                    ...
                    success: function (data) {
                       ...
                       // return false;
                        //รับค่า order detail ที่เหลือ ถ้าเป็น 0 ให้เครียโต๊ะ
                        if (data.home_or_table == 'table') {
                            //กินร้าน
                            if (parseInt(data.row_count) == 0) {
                                clear_table_no_popup();
                            }
                        }else{
                            //กลับบ้าน
                             if (parseInt(data.row_count) == 0) {
                                clear_backhome_no_popup();
                            }
                        }
...
//                                                    console.log(obj);  
    ...
    function select_table(ele) {
        ...
        //ปิดการ เครียโต๊ะถ้ามีการทำแล้ว และกำลังทำ
       // console.log($(ele));
        if( $(ele).hasClass('bg-green') || $(ele).hasClass('bg-yellow')){
            //console.log('has');
            $('.clear-table').attr('disabled',true);
        }else{
              $('.clear-table').attr('disabled',false);
        }
