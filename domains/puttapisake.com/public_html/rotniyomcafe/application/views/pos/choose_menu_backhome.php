            ...
            <form action="<?= base_url() ?>pos/buy_back_home" method="POST">
                ...
                <div class="box box-widget">
                    <div class="box-header with-border bg-purple">
                        <div class="col-md-12">
                            <div class="pull-left caption font-18" style="margin-right: 30px;"><i class="fa fa-reorder"></i>  <span style="font-size: 20px;"># Add Queue</span></div>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <button type="submit" class="btn btn-block bg-primary" style="font-size: 18px;" name="btn_submit" value="add_queue"> # Add Queue</button>
                            </div>
                        </div>
                    </div>
                </div>
