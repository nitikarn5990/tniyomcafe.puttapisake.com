    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="<?= base_url('menu/edit/' . $id) ?>" method="POST">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">ชื่อสินค้า</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo $res_menu['product']; ?>" class="form-control"  name="product" data-validation="required" >
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <select class="form-control" name="category_id" data-validation="required">
                                    ...
                                    if (isset($res_category)) {
                                        foreach ($res_category as $rows) {
                                            ?>
                                    <option value="<?= $rows['id'] ?>" <?=$res_menu['category_id'] == $rows['id'] ? 'selected':'' ?>><?= $rows['category_name'] ?></option>
                                        <?php
                                        }
                                    }
                                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo $res_menu['hot']; ?>" class="form-control"  name="hot" data-validation="required,number" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">ราคาเย็น</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo $res_menu['iced']; ?>" class="form-control"  name="iced" data-validation="required,number" >
                            </div>
                        </div>
                        <div class="form-group">
